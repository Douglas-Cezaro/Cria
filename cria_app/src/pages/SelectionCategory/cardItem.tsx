...
export default function CardItem({ category, onSelectCategory, isSelected }: Props) {
    return (

        <CardItens onPress={() => onSelectCategory(category)} isSelected>
            <CardLabel>{category.name}</CardLabel>
            <CardImage source={categoryImg} style={[isSelected ? Styles.active : Styles.inactive]} />
        </CardItens>
